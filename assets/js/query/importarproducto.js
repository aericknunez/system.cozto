    ...
    $("#btn-file").click(function (event) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                $("#contenido").html('<div class="row justify-content-center" ><h2>Espere... Sus datos estan siendo procesados</h2></div><div class="row justify-content-center" ><img src="assets/img/loa.gif" alt=""></div>');
            },
