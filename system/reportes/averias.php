...
?>
  ...
  <div class="row justify-content-md-center">
    <div class="col-12 col-md-auto">
        <form name="form-averias" method="post" id="form-averias">
  ...
  <div class="row justify-content-md-center">
    ...
    <button class="btn btn-info my-2 btn-rounded btn-sm waves-effect" type="submit" id="btn-averias" name="btn-averias">Mostrar Datos</button>
      </form> 
    </div>
  </div>
