...
?>
  ...
  <div class="row justify-content-md-center">
    <div class="col-12 col-md-auto">
        <form name="form-ingresos" method="post" id="form-ingresos">
  ...
  <div class="row justify-content-md-center">
    ...
    <button class="btn btn-info my-2 btn-rounded btn-sm waves-effect" type="submit" id="btn-ingresos" name="btn-ingresos">Mostrar Datos</button>
      </form> 
    </div>
  </div>
