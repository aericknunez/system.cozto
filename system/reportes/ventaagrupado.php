...
?>
  ...
  <div class="row justify-content-md-center">
    <div class="col-12 col-md-auto">
        <form name="form-vantaagrupado" method="post" id="form-vantaagrupado">
  ...
  <div class="row justify-content-md-center">
    ...
    <button class="btn btn-info my-2 btn-rounded btn-sm waves-effect" type="submit" id="btn-vantaagrupado" name="btn-vantaagrupado">Mostrar Datos</button>
      </form> 
    </div>
  </div>
