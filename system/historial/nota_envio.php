...
?>
  ...
  <div class="row justify-content-center">
    <div class="col-12 col-md-auto">
     <form name="form-envio" method="post" id="form-envio">
    <input placeholder="Seleccione una fecha" type="text" id="fecha" name="fecha" class="form-control datepicker my-2">
    </div>
  </div>

<div class="row justify-content-center">
  <button class="btn btn-info my-2 btn-rounded btn-sm waves-effect" type="submit" id="btn-envio" name="btn-envio">Mostra Datos</button>
  </form> 
</div>
...
<?php 
	...
	$historial->NotasEnvio(date("d-m-Y"));
