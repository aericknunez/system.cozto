...
?>
  ...
  <div class="row justify-content-md-center">
    <div class="col-md-4 col-md-auto">
        <form name="form-cortez" method="post" id="form-cortez">
  ...
  <div class="row justify-content-center">
    <button class="btn btn-info my-2 btn-rounded btn-sm waves-effect" type="submit" id="btn-cortez" name="btn-cortez">Mostra Datos</button>
