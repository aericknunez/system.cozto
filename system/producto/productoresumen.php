...
<div id="msj"></div>
<h2 class="h2-responsive">Listado de Productos</h2>


<div id="contenido">
   <?php $producto->ProductosResumen(); ?>
</div>

<div class="row justify-content-center">
  <a href="system/imprimir/imprimir.php?op=12" class="btn btn-info my-2 btn-rounded btn-sm waves-effect" title="Imprimir todos los productos">Imprimir Todo</a>
</div>
