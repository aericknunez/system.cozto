...
<input type="hidden"  id="pago" name="pago" value="1"> 


<input type="text"  id="gasto" name="gasto" class="form-control mb-3" placeholder="Remesa">
...
<button class="btn btn-info my-4" type="submit" id="btn-gastos" name="btn-gastos">Agregar Remesa</button>
 </form>
