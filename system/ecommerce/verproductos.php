...
<div id="contenido">
   <?php $ecommerce->VerProductosEcommerce(1, "producto.id", "asc"); ?>
</div>


<!-- Ver producto -->
<div class="modal" id="ModalVerProducto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"  data-backdrop="false">
