...
$printer -> setJustification(Printer::JUSTIFY_CENTER);
$printer->text("AGENCIA Y LACTEOS LA FE");

$printer -> setTextSize(1, 2);
$printer -> setEmphasis(false);
$printer->feed();
$printer->text("Residencial Sevilla 1 Pol. AA, casa # 9 ");

$printer->feed();
$printer->text("Sobre el Bulevard del Prado, Ciudad Real,");
$printer->feed();
$printer->text("San Sebastian Salitrillo, Santa Ana");

$printer->feed();
$printer->text("Tel: 7918-9379");
