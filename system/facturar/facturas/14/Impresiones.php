...
$printer -> setJustification(Printer::JUSTIFY_CENTER);
$printer->text("INNOVACIONES YESICA");


$printer->feed();
$printer->text("Av. Francisco Menendez,");
$printer->feed();
$printer->text("# 2-8 Ahuachapan.");
$printer->feed();
$printer->text("Tel: 7165-6017");


$printer->feed();
$printer->text("Giro: Venta al por menor de otros productos N.C.P");
